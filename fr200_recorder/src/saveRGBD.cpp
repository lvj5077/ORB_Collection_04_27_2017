...
void ImageGrabber(const sensor_msgs::ImageConstPtr& msgRGB,const sensor_msgs::ImageConstPtr& msgD)
{
    ...
    cout<< index << "  "<< "rgb_stamp: "<< h_rgb.stamp << "  d_stamp: "<<h_d.stamp <<endl;
    ...
    imwrite("/home/jin/myImage/color/" + index+".png", cv_ptrRGB->image);
    imwrite("/home/jin/myImage/depth/" + index+".png", cv_ptrD->image);

    stringstream ss;
    ss << index <<" "<< h_rgb.stamp;
