...
class CamModel
{
  public:
    ...
    fx(fx1), fy(fy1), cx(cx1), cy(cy1), k1(k11), k2(k22), p1(p11), p2(p22), k3(k33), k4(k44), k5(k55), k6(k66), z_offset(0), m_z_scale(1.), m_rows(144), m_cols(176), m_height(144), m_width(176)
  {}
    virtual ~CamModel(){}
  public:
